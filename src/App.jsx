      ...
      >
        <CardHeader className="space-y-3">
          <SectionHeader
            ...
            subtitle="Track house progress in Landsraad-style tiles and command weekly turn-ins."
            isDark={isDark}
          />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3">
              {visibleHouses.map((h) => {
                ...
                return (
                  <div
                    key={h.id}
                    className={`relative rounded-[4px] border p-3 space-y-3 shadow-md ${
                      isDark
                        ? "bg-[linear-gradient(165deg,#1a140f_0%,#17120d_100%)] border-emerald-900/80"
                        : "bg-[linear-gradient(165deg,#fffaf0_0%,#f8f0e2_100%)] border-emerald-500/60"
                    }`}
                  >
                    <div
                      className={`absolute inset-x-0 top-0 h-1 ${
                        isDark ? "bg-emerald-700/70" : "bg-emerald-400/70"
                      }`}
                    />
                        ...
                        <Button
                          ...
                          className={`border ${
                            h.pinned
                              ...
                              : isDark
                                ? "border-emerald-900/60 bg-[#1f1710] text-[#d8c9ad] hover:bg-[#2a2118]"
                                : "border-emerald-500/40 bg-[#f7ead2] text-[#6e5a39] hover:bg-[#efe1c8]"
                          }`}
                        >
                    ...
                    <div className="space-y-2">
                      ...
                      {h.goals.length === 0 && (
                        <div
                          className={`rounded-[4px] border border-dashed p-3 text-xs ${
                            isDark
