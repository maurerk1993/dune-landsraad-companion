...
const APP_CHANGE_NOTES = [
  {
    version: "3.7.0",
    notes: [
      "Hardened post-login session handling to avoid blank-screen crashes when session user payload is incomplete.",
    ],
  },
  {
    version: "3.6.0",
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div className="flex flex-col items-start md:items-end gap-2">
              <div className={`text-xs ${isDark ? "text-[#c8bca7]" : isAtreides ? "text-[#c4d8cc]" : isSpice ? "text-[#5d3a79]" : "text-[#6b5636]"}`}>
                Signed in as <span className="font-semibold">{session?.user?.email || "Unknown account"}</span>
              </div>
